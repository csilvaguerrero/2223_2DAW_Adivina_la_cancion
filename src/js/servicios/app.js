...
import{VistaResumen} from './../vistas/vistaresumen.js'
...
class Controlador{
	...
	iniciar(){
		...
		this.divResumen=document.getElementById('guardar-puntuacion')
		this.divFormulario=document.getElementById('divPuntuacion')
		...
		this.divResumen = new VistaResumen(this, this.divResumen)
