...
export class VistaCategorias extends Vista{
	...
	constructor(controlador, div){
		...
		this.pulsarComenzarJjuego = document.getElementById('comenzarJuego')
		this.pulsarJuego.addEventListener('click', this.juego.bind(this));
		this.pulsarComenzarJjuego.addEventListener('click', this.comenzarJuego.bind(this))
